...
- **Afrihost** supplies the domain name (e.g. straatmag.co.za).
...
2. In **Vercel**: open the straat-mag project, go to **Settings, then Domains**,
   type your domain (e.g. straatmag.co.za) and click **Add**. Vercel shows you
...
3. In **Afrihost ClientZone**: open your domain's **DNS management** and add
   ...
   - An **A record** for `straatmag.co.za` pointing to `76.76.21.21`
